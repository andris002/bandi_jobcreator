...
JOBCREATOR.Language = {
    ['hu'] = {
        ...
        stash = "%s tároló",
        prop_rotate = "Nyilak: Mozgatás | Q/E: Forgatás | SHIFT/CTRL: Fel/Le | ENTER: Lerakás",
        prop_delete = "Nyomd meg az [E] gombot a tárgy törléséhez",
        ui = {
            TITLE = "JobCreator",
    ...
    ['en'] = {
        ...
        stash = "%s storage",
        prop_rotate = "Arrows: Move | Q/E: Rotate | SHIFT/CTRL: Up/Down | ENTER: Place",
        prop_delete = "Press [E] to delete the object",
        ui = {
            TITLE = "JobCreator",
            CREATE = "Create Job",
